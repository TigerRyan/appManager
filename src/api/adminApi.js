...
// 创建管理员
export const createAdminApi = ({avatar, account, password, name, birthday, sex = 1, email, phone, roles = [],type} = {}) => ajax.post(`${ROOT}/create`, {
  avatar, account, password: password && md5(password), name, birthday, sex, email, phone, roles,type
})
// 修改管理员
export const updateAdminApi = ({id, avatar, account, password, name, birthday, sex = 1, email, phone, roles = [],type} = {}) => ajax.put(`${ROOT}/update`, {
  id, avatar, account, password: password && md5(password), name, birthday, sex, email, phone, roles,type
})
// 修改我的资料
