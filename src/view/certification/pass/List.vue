  ...
  <div class="content_data">
    ...
    <TablePage>
      ...
      <el-table :data="data.list" v-loading="data.loading" element-loading-text="拼命加载中...">
        ...
        <el-table-column prop="updatetime" label="认证时间" :formatter="dateTimeFilter" min-width="150"/>
      </el-table>
    </TablePage>
...
<script>
  import {getCheckListApi, providerNoPassList, providerWaitPassList, exportCheckListApi} from '../../../api/checkApi'
  ...
  export default {
    ...
    data() {
      return {
        data: {page: 1, pageSize: 10, list: [], total: 0, status: 2, loading: false, name: null},
      }
    },
    methods: {
      dateTimeFilter,
