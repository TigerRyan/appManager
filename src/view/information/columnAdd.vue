<template>
  <div class="content_data">
    ...
    <div>添加栏目</div>
    <el-button type="primary" @click="editLevel(false)">添加等级</el-button>
    <TablePage>
      <el-table :data="data.list" v-loading="data.loading" element-loading-text="拼命加载中...">
        ...
        <el-table-column label="操作" width="180">
          <template slot-scope="scope">
            <el-button type="edit" size="small" @click="editLevel(scope.row)">编辑</el-button>
            <el-button type="del" size="small" @click="del((data.page - 1) * data.pageSize + scope.$index,scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </TablePage>
