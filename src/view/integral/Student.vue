<template>
  <div class="content_data studentIntegral">
    <Breadcrumb/>
    <ul class="cate_list">
      ...
      <el-table :data="data.list" v-loading="data.loading" element-loading-text="拼命加载中...">
        ...
        <!--<el-table-column label="状态" min-width="140">-->
          <!--<template slot-scope="scope">-->
            <!--<el-switch v-model="scope.row.status" active-color="#13ce66" inactive-color="#ff4949" active-text="启用" inactive-text="禁用" :active-value="0" :inactive-value="1" @change="statusChange(scope.row)" :disabled="disabled"/>-->
          <!--</template>-->
        <!--</el-table-column>-->
    ...
    <el-dialog title="编辑" :visible.sync="show" :modalAppendToBody="false" width="600px">
      <el-form :model="dialog" :rules="rules" ref="dialog" labelWidth="100px">
        ...
        <!--<el-switch v-model="dialog.status" active-color="#13ce66" inactive-color="#ff4949" active-text="启用" inactive-text="禁用" :active-value="0" :inactive-value="1"/>-->
        <!--</el-form-item>-->
      </el-form>
  ...
  export default {
    ...
    data() {
      return {
        ...
        data: {page: 1, pageSize: 10, list: [], total: 0, taskUserType :1, taskType: null, loading: false},
        dialog: {},
