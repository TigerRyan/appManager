  ...
  <div class="content_data">
    ...
    <TablePage>
      ...
      <el-table :data="data.list" v-loading="data.loading" element-loading-text="拼命加载中...">
        ...
        <el-table-column prop="courseId" label="课程ID" :formatter="defValFilter01" min-width="110"/>
        ...
        <el-table-column prop="createTime" label="购买时间" :formatter="dateTimeFilter" min-width="130"/>
      </el-table>
    </TablePage>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        data: {page: 1, pageSize: 10, total: 0, list: [], loading: false, status: 2, keyWord: null},
      }
    },
    methods: {
      dateTimeFilter,
