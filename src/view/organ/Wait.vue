...
<template>
  <div class="organRecommended content_data" >
    ...
    <div class="search kind">
      ...
      <el-input v-model.trim="data.query" clearable @keydown.enter.native="search"  placeholder="请输入机构名称或任务ID号查询" style="width: 276px;"></el-input>
    ...
    <TablePage>
      <el-table :data="data.list" v-loading="data.loading" element-loading-text="拼命加载中..." ref="multipleTable">
        ...
        <el-table-column label="操作" min-width="150">
          <template slot-scope="scope">
            <el-button plain type="danger" size="middle" @click="cancleHandle(scope.row)" :disabled='disabled'>取消推荐</el-button>
          </template>
        </el-table-column>
      </el-table>
