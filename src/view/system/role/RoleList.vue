<template>
  <div class="content_data">
    <Breadcrumb/>
    <el-button type="primary" icon="el-icon-plus" @click="$router.push({name: 'roleEdit', params: {id: CREATE}})" :disabled="disabled">添加角色</el-button>
    <el-table :data="data.list" v-loading="data.loading" element-loading-text="拼命加载中...">
      ...
      <el-table-column label="操作" width="100" fixed="right">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="$router.push({name: 'roleEdit', params: {id:scope.row.id}})" :disabled="disabled">编辑</el-button>
